/// <summary>
/// TableExtension YVS Transfer Receipt Header (ID 75007) extends Record Transfer Receipt Header.
/// </summary>
tableextension 75007 "YVS Transfer Receipt Header" extends "Transfer Receipt Header"
{
    fields
    {
