/// <summary>
/// Report YVS Inventory Movement (ID 75000).
/// </summary>
report 75000 "MRC Inventory Movement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_75000_InventoryMovement.rdl';
    ...
    dataset
    {
        dataitem("Item Journal Batch"; "Item Journal Batch")
        {
            ...
            dataitem("Item Journal Line"; "Item Journal Line")
            {
                ...
                column(YVS_Approve_Status; Status) { }
                ...
                begin
                    ...
                    if "YVS Approve Status" = "YVS Approve Status"::Open then
                        Status := 'Open';
                    if "YVS Approve Status" = "YVS Approve Status"::"Pending Approval" then
                        Status := 'Pend. Approval';
                    if "YVS Approve Status" = "YVS Approve Status"::Released then
                        Status := 'Released';
                end;
